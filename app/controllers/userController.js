...
let userController = {
  ...
  userSubscribeToClient:function(req,res){
    ...
    viewUserReservations: function(req,res){
      var user_id= req.session.user_name;
      Reservation.find({'user_name': user_name}, function(err, reservations){
             ...
             if(err){
               ...
               res.json('viewUserReservations', {reservations});
