...
let clientController ={
  ...
  searchForClients:function(req, res){// search function byy client name and event name
    ...
    addNewClient:function(req, res){
      ...
      viewClientReservations:function(req, res){

        var client_name = req.session.client_name;
        Reservation.find({'client_name':client_name}, function(err, reservations){
          ...
          if(err){
            ...
            console.log(err.message);
              ...
              res.json('viewClientReservations', {reservations});
