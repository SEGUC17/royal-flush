...
searchForClientByLocation: function (req, res) {
    Client.findByClientLocation(req.body.searchKey, function (err, clients) {
      if (err) throw err;
      res.send(clients);
    });

  },
  searchForClientByCategory: function (req, res) {
    Client.findByClientCategory(req.body.searchKey, function (err, clients) {
      if (err) throw err;
      res.send(clients);
    });
  ...
  // searchForClientsAndEvents: function (req, res) {// search function byy client name and event name
